...
* For other users, the Vipps landing page is opened in a browser.  The user can then enter their phone number.
...
by providing `Request-Id` (or `Idempotency-key`- deprecated) header of the
